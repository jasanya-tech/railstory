...
<nav class="navbar navbar-light navbar-expand-lg navbar-light bg-light fixed-top home">
    <div class="container">
        <a href="<?= base_url() ?>" class="navbar-brand d-flex w-50 mr-auto">
            <img src="<?= base_url('images/brand/1.png') ?>" alt="">
        </a>
        ...
        <div class="navbar-collapse collapse w-100" id="collapsingNavbar3">
            ...
            <ul class="navbar-nav ml-auto">
                <?php if ($this->session->userdata('user_id')) { ?>
                    <?php if (get_role($this->session->userdata('user_id')) == 'admin') : ?>
                        <!-- Jika pengguna sudah login dan admin -->
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url('admin'); ?>">Dashboard</a>
                        </li>
                    <?php else : ?>
                        <!-- Jika pengguna sudah login dan selain admin -->
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url('article/create'); ?>">Posting</a>
                        </li>
                    <?php endif; ?>
