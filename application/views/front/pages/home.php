<?php if ($this->session->flashdata('message')) : ?>
   <div class="alert alert-success alert-dismissible fade show text-center" role="alert" style="margin: 90px">
               ...
               <div class="col-lg-4">
                  <div class="container">
                     <div class="date text-center">
                        ...
                        <a href="<?= base_url("blog/read/$f->seo_title") ?>"><i class="fa fa-calendar" aria-hidden="true"></i>14 Mei 2023</a>
                     </div>
