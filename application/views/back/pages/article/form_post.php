         ...
         <div id="content">
            ...
            <div class="container">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                     <textarea name="content" id="editor"><?= $input->content ?></textarea>
               ...
               <div class="form-group row">
                  ...
                  <div class="col">
                     ...
                     <select class="form-control" id="is_active" name="is_active">
                        <option value="Y" <?= set_value('is_active', $input->is_active) == 'Y' ? 'selected' : ''  ?>>Ya</option>
                        <option value="N" <?= set_value('is_active', $input->is_active) == 'N' ? 'selected' : ''  ?>>Tidak</option>
                     </select>
                  </div>
               </div>
